...
const mockApiDataTour =  [
      {
        ...
        "programs": [
          ...
          },
          {
            ...
            "description": "Text 2.Встреча группы в аэропорту Бишкека Манас с 15:00 до 15:30. Если ваш самолет прибывает в другое время, сообщите нам об этом, мы поможем найти лучшее решение. На трансфере едем в гостиницу Бишкека. Оставляем вещи и идем на обед. После будет обзорная вечерняя экскурсия по старому центру с экскурсоводом. Мы пройдем цирк, музей Фрунзе, Администрацию президента, можно увидеть, где работает глава государства, и познакомиться с архитектурой этого исторического места. Увидим исторический музей, площадь Ала-Тоо. Рядом найдем нулевой километр, символический центр города. В завершении погуляем по площади Победы. Увидим русский театр драмы и оперный театр. Ночуем в комфортной гостинице Бишкека.",
            "pictures": ['https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/toomas-tartes-yizrl9n-eda-unsplash-1571336397.jpg?crop=0.601xw:0.899xh;0.340xw,0.101xh&resize=640:*','https://www.wildnatureimages.com/images/640/070620-014-The-Tetons.jpg', 'https://images.pexels.com/photos/210243/pexels-photo-210243.jpeg?cs=srgb&dl=pexels-pixabay-210243.jpg&fm=jpg','https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8bW91bnRhaW4lMjBoaWtlfGVufDB8fDB8fHww']
        }
        ]
      }
    ]
export default mockApiDataTour;
